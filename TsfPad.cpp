...
int APIENTRY MyWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    if (FAILED(
            CoCreateInstance(CLSID_TF_ThreadMgr, NULL, CLSCTX_INPROC_SERVER, IID_ITfThreadMgr, (void **)&g_pThreadMgr)))
    {
        goto Exit;
    }
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    g_hwnd = CreateWindow(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, NULL, NULL,
                          hInstance, NULL);
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    return MyWinMain(GetModuleHandle(NULL), NULL, GetCommandLine(),
